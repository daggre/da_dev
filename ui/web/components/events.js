...
import { searchAnimDicts, playConfiguredAnimations, stopAnimation, playSelectedAnimation, addAnimation, resetSelectedAnimConfig, clearAnimation, deleteAllAnimations, setSelectedAnimation } from '../components/anims.js';
...
import { selectSpawnType, selectNearbyOrigin, toggleNearbyFilter, getTrackedObjects, toggleVisible, toggleFrozen, toggleCollision } from '../components/obj.js';
import { saveScene, clearScene, showExport, showImport, reloadScene, deleteScene, handleEscape } from '../components/scene.js';
import { setTooltips } from '../components/tooltip.js';
import { toggleHideCamera, updateCamera } from '../components/camera.js';
import { setBorder, setCurvedBorder, setCurvedBorderAmount } from '../utils/theme.js';
import { sendClientMessage } from '../utils/msg.js';
import { isVisible, isInterruptingElement } from '../utils/nav.js';
...
import { DropDownMapOptions, showDropdown } from '../components/dropdown.js';
import { searchSpawnObject, tagSelectSort, placeOnGround, setRotation } from '../components/obj.js';
