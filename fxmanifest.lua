...
client_scripts {
    ...
    '@da_lib/data/control.lua',
    '@da_lib/data/hunting.lua',
    ...
    'src/mode_prop_cl.lua',
    'src/teleport_cl.lua',
    'src/ped_cl.lua',
    'src/bullride_cl.lua',
    'src/bones_cl.lua',
    'src/attributes_cl.lua',
    'src/carcass_probe_cl.lua',
    'src/event_cl.lua',
...
files {
    ...
    'ui/web/src/bones.js',
    'ui/web/src/inspect.js',
    'ui/web/src/keymon.js',
    'ui/web/src/attributes.js',
    'ui/web/src/msg.js',
    'ui/web/src/nav.js',
    'ui/web/src/obj.js',
    'ui/web/src/prop.js',
