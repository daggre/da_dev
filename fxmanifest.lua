...
files {
    ...
    'ui/web/components/hud/anim.js',
    'ui/web/components/hud/common.js',
    'ui/web/components/hud/help.js',
    'ui/web/components/hud/obj.js',
    'ui/web/components/hud/settings.js',
